...
|Description|Query|
|-----------|-----|
|Show all virtual machines ordered by name in descending order|```kusto project name, location, type | where type =~ 'Microsoft.Compute/virtualMachines' | order by name  desc ```|
